function [rX] = Denoising_CMESSC(F,row,col, sparseC,cluster)
% =========================================================================
...
%                            dictionary.
% sparseC                    using sparse coding (true) or not (false)
% cluster                    using cluster filtering (true) or not (false)
% =========================================================================
% OUTPUT ARGUMENTS:
...
if cluster
    ...
    par.h = 0.02;%0.02;
    par.win = 1;
    rX = intraClusterFiltering(rX,row,col,par);
end
